...
import {CrossIcon, Icon, Spinner, TickIcon, TrashIcon} from "evergreen-ui";
import {useSearchParams} from "react-router-dom";
import {ContentRequest, IPostContent, IQuiz, ITopic} from "@thedashboardai/train-edu-front-end-api-wrapper";
...
function DeletePopup({show, onHide, confirm, topic}: DeleteProps) {
	return (
		<Modal
			show={show}
			onHide={() => {
		...
		>
			...
			<Modal.Body>
				<p>Are you sure you want delete this content? It cannot be restored once deleted.</p>
			</Modal.Body>
			<Modal.Footer>
				<button
